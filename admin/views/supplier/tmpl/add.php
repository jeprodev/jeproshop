        ...
        <div class="panel" >
            <div class="panel-content well form-horizontal" >
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_name" name="jform[name]" value="" required="required" /> </div>
                </div>
                <div class="control-group" >
                ...
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_company" name="jform[company]" required="required" maxlength="32" value=""/></div>
                </div>
                <div class="control-group" >
                ...
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_phone" name="jform[phone]" required="required" maxlength="16" value="" /></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_mobile_phone" name="jform[mobile_phone]" required="required" maxlength="16" value="" /></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_" name="jform[address]" maxlength="128" required="required" value="" /></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_address_2" name="jform[address_2]" maxlength="128" value="" /></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_" maxlength="12" /></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_city" name="jform[city]" maxlength="32" required="required" value="" /></div>
                </div>
                <div class="control-group" >
                ...
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $this->helper->multiLanguageInputField('meta_title', null); ?></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $this->helper->multiLanguageInputField('meta_description', null); ?></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $this->helper->multiLanguageInputField('meta_keywords', null); ?></div>
                </div>
                <div class="control-group" >
