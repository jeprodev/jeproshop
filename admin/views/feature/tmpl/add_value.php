        ...
        <div class="panel form-horizontal" >
            <div class="panel-content well" >
                <div class="control-group" >
                    ...
                    <div class="controls" >
                        <select id="jform_feature" name="jform[feature_id]" required="required" >
                            <?php foreach($this->features as $feature){ ?>
                                <option value="" ><?php echo ucfirst($feature->name); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $this->helper->multiLanguageInputField('feature_value', 'jform', true); ?></div>
                </div>
            </div>
        </div>
    </div>
