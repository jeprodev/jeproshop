...
<div class="panel" id="jform_carrier_general_setting" >
    ...
    <div class="panel-content well" >
        ...
        <div class="control-group" >
            ...
            <div class="controls" ><?php echo $this->helper->multiLanguageInputField('delay', true, null, 128); ?> </div>
        </div>
        <div class="control-group" >
            ...
            <div class="controls" ><input type="text" size="1" name="jform[grade]" id="jform_grade" value="" /></div>
        </div>
        <div class="control-group" >
            ...
            <div class="controls" ><input type="text" id="jform_carrier_logo" /></div>
        </div>
        <div class="control-group" >
            ...
            <div class="controls" ><input type="text" id="jform_tracking_url" name="jform[tracking_url]"  class="url" value="" /></div>
        </div>
    </div>
</div>