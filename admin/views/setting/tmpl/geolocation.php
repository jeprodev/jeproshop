    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> >
        <div class="box_wrapper jeproshop_sub_menu_wrapper">
            <fieldset class="btn-group">
                <a href="<?php echo JRoute::_('index.php?option=com_jeproshop&view=setting&task=general'); ?>" class="btn jeproshop_sub_menu btn-success" ><i class="icon-gears" ></i> <?php echo JText::_('COM_JEPROSHOP_GENERAL_LABEL'); ?></a>
        ...
        <div class="panel" >
            ...
            <div class="panel-content well" >
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $helper->radioButton('enable_geolocation', 'edit', $this->enable_geolocation); ?></div>
                </div>
            </div>
        </div>
        <div class="panel" >
            ...
            <div class="panel-content well" >
                <div class="control-group" >
                    <div class="control-label" ><label for="jform_geolocation_behavior" title="<?php echo JText::_('COM_JEPROSHOP_GEOLOCATION_BEHAVIOR_TITLE_DESC'); ?>"><?php echo JText::_('COM_JEPROSHOP_GEOLOCATION_BEHAVIOR_LABEL'); ?></label></div>
                    <div class="controls" >
                        <select id="jform_geolocation_behavior" name="jform[geolocation_behavior]" >
                            ...
                            <option value="<?php echo COM_JEPROSHOP_GEOLOCATION_NO_ORDER; ?>" <?php if($this->geolocation_behavior == COM_JEPROSHOP_GEOLOCATION_NO_ORDER){ ?> selected="selected" <?php } ?>><?php echo JText::_('COM_JEPROSHOP_VISITOR_CANT_SEE_CATALOGS_LABEL'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="control-group" >
                    <div class="control-label" ><label for="jform_geolocation_un_allowed_behavior" title="<?php echo JText::_('COM_JEPROSHOP_GEOLOCATION_BEHAVIOR_TITLE_DESC'); ?>"><?php echo JText::_('COM_JEPROSHOP_GEOLOCATION_BEHAVIOR_LABEL'); ?></label></div>
                    <div class="controls" >
                        <select id="jform_geolocation_un_allowed_behavior" name="jform[geolocation_un_allowed_behavior]">
                            ...
                            <option value="<?php echo COM_JEPROSHOP_GEOLOCATION_NO_ORDER; ?>" <?php if($this->geolocation_un_allowed_behavior == COM_JEPROSHOP_GEOLOCATION_NO_ORDER){ ?> selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_VISITOR_CANT_SEE_CATALOGS_LABEL'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="control-group" >
                    <div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_USE_PURIFIER_LIBRARY_LABEL'); ?></label></div>
                    <div class="controls" ><?php  echo $helper->radioButton('use_purifier_library', 'edit', $this->use_purifier_library); ?></div>
                </div>
                <!-- div class="control-group" >
                ...
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $helper->radioButton('display_supplier_manufacturer', 'edit', $this->display_supplier_manufacturer); ?></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $helper->radioButton('display_best_sells', 'edit', $this->display_best_sells); ?></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $helper->radioButton('activate_multishop', 'edit', $this->activate_multishop); ?></div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls" >
                        <select name="jform[shop_activity]" id="jform_shop_activity" >
                            ...
                            <option value="sport_and_entertainment" <?php if($this->shop_activity == 'sport_and_entertainment'){ ?> selected="selected" <?php } ?>  ><?php echo JText::_('COM_JEPROSHOP_SPORT_AND_ENTERTAINMENT_LABEL'); ?></option>
