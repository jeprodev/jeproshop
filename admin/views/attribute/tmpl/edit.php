...
<form action="<?php echo JRoute::_('index.php?option=com_jeproshop&view=attribute'); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal" >
    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> >
        ...
        <div class="panel" >
            <div class="panel-title" ><i class="icon-info-sign" ></i> <?php echo JText::_('COM_JEPROSHOP_ATTRIBUTES_VALUES_LABEL'); ?></div>
            <div class="panel-content" >
                ...
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $this->helper->multiLanguageInputField('name', true, $this->attribute->name, null, JText::_('COM_JEPROSHOP_INVALID_CHARACTERS_LABEL')); ?> </div>
                </div>
