...
<form action="<?php echo JRoute::_('index.php?option=com_jeproshop&view=tax'); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal" >
    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> >
        ...
        <div class="panel" >
            ...
            <div class="panel-content well" >
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_name" name="jform[name]" required="required" value="<?php echo $this->tax_rules_group->name; ?>" /></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $this->helper->radioButton('published', 'edit', $this->tax_rules_group->tax_rules_group_id); ?></div>
                </div>
        ...
        <div class="panel" >
            <div class="panel-title" ><i class="icon-money" ></i> <?php echo JText::_('COM_JEPROSHOP_TAX_RULES_LABEL'); ?></div>
            <div class="panel-content well" >
                <table class="table striped-table" >
                    ...
                    <tr>
                        ...
                        <th width="10%" class="nowrap" ><?php echo JText::_('COM_JEPROSHOP_COUNTRY_LABEL'); ?></th>
                        <th width="10%" class="nowrap" ><?php echo JText::_('COM_JEPROSHOP_STATE_LABEL'); ?></th>
                        <th width="10%" class="nowrap" ><?php echo JText::_('COM_JEPROSHOP_ZIP_POSTAL_CODE_LABEL'); ?></th>
                    ...
                    <?php if(isset($this->tax_rules)){
                        foreach($this->tax_rules as $index => $tax_rule){ //print_r($tax_rule);
                            ...
                            <tr class="row_<?php echo ($index%2); ?>" >
                                ...
                                <td width="10%" class="nowrap"><a href="<?php echo $countryLink; ?>" ><?php echo ucfirst($tax_rule->country_name); ?></a> </td>
                                <td width="10%" class="nowrap"><?php echo ucfirst($tax_rule->state_name); ?></td>
                                <td width="10%" class="nowrap center hidden-phone" ><?php echo $tax_rule->zipcode; ?></td>
                                <td width="5%" class="nowrap center">
                                    <?php if($tax_rule->behavior == 0) { echo JText::_('COM_JEPROSHOP_THIS_TAX_ONLY_LABEL'); }else if($tax_rule->behavior == 1){ echo JText::_('COM_JEPROSHOP_COMBINE_LABEL'); }else if($tax_rule->behavior == 2){ echo JText::_('COM_JEPROSHOP_ONE_AFTER_ANOTHER_LABEL'); } ?>
                                </td>
                                <td width="5%" class="nowrap center"><?php echo $tax_rule->rate . '%'; ?></td>
                                <td width="5%" class="nowrap hidden-phone"><?php echo $tax_rule->description; ?></td>
        ...
        <input type="hidden" name="tax_rules_group_id" value="<?php echo $this->tax_rules_group->tax_rules_group_id; ?>" />
