...
<form action="<?php echo JRoute::_('index.php?option=com_jeproshop&view=tax'); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal" >
    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> >
        ...
        <div class="panel" >
            <div class="panel-title" ><?php echo JText::_('COM_JEPROSHOP_YOU_ARE_ABOUT_TO_ADD_LABEL') . ' ' .JText::_('COM_JEPROSHOP_A_NEW_TAX_LABEL'); ?></div>
            <div class="panel-content well" >
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $this->helper->multiLanguageInputField('name', 'jform', true, null, null, ''); ?></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_tax_rate" name="jform[tax_rate]" maxlength="6" required="required" /></div>
                </div>
                <div class="control-group" >
