...
?>
<form action="<?php echo JRoute::_('index.php?option=com_jeproshop&view=group'); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal">
    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> > 
        <div class="box_wrapper jeproshop_sub_menu_wrapper">
            <fieldset class="btn-group">
                ...
                <a href="<?php echo JRoute::_('index.php?option=com_jeproshop&view=group'); ?>" class="btn jeproshop_sub_menu btn-success" ><i class="icon-group" ></i> <?php echo ucfirst(JText::_('COM_JEPROSHOP_GROUPS_LABEL')); ?></a>
        ...
        <div class="panel" >
        	...
        	<div class="panel-content well" >
        		<div class="control-group" >
        			<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_GROUP_NAME_LABEL'); ?></label></div>
        			<div class="controls" ><?php echo $this->helper->multiLanguageInputField('name', 'jform'); ?></div>
        		</div>
        		<div class="control-group" >
        			<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_GROUP_REDUCTION_LABEL'); ?></label></div>
        			<div class="controls" >
        		...
        		<div class="control-group" >
        			<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_DISPLAY_PRICES_LABEL'); ?></label></div>
        			<div class="controls" >
        		...
        		<div class="control-group" >
        			<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_ASSOCIATED_CATEGORIES_LABEL'); ?></label></div>
        ...
        <div class="panel" >
        	...
        	<div class="panel-content well" >
        		<div class="half_wrapper left" >
        			<div class="control-group" >
        				<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_SOCIAL_NETWORK_SHARING_LABEL'); ?></label></div>
        				<div class="controls" >
        			...
        			<div class="control-group" >
        				<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_BANNERS_BLOCK_LABEL'); ?></label></div>
        				<div class="controls" >
        			...
        			<div class="control-group" >
        				<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_BANK_WIRE_LABEL'); ?></label></div>
        				<div class="controls" >
        			...
        			<div class="control-group" >
        				<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_BEST_SALES_LABEL'); ?></label></div>
        				<div class="controls" >
        			...
        			<div class="control-group" >
        				<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_CART_BLOCK_LABEL'); ?></label></div>
        				<div class="controls" >
        			...
        			<div class="control-group" >
        				<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_SOCIAL_BLOCK_LABEL'); ?></label></div>
        				<div class="controls" >
        			...
        			<div class="control-group" >
        				<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_CATEGORIES_BLOCK_LABEL'); ?></label></div>
        				<div class="controls" >
        			...
        			<div class="control-group" >
        				<div class="control-label" ><label><?php echo JText::_('COM_JEPROSHOP_CURRENCIES_BLOCK_LABEL'); ?></label></div>
        				<div class="controls" >
