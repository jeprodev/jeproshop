        ...
        <div class="panel" >
            <div class="panel-content well" >
                <div class="control-group" >
                    <div class="control-label"><label for="jform_-lbl" ><?php echo JText::_('COM_JEPROSHOP_FILENAME_LABEL'); ?></label></div>
                    <div class="controls"><?php echo $this->helper->multiLanguageInputField('filename', true, null, null); ?></div>
                </div>
                <div class="control-group" >
                    <div class="control-label"><label for="jform_-lbl" ><?php echo JText::_('COM_JEPROSHOP_DESCRIPTION_LABEL'); ?></label></div>
                    <div class="controls"><?php echo $this->helper->multiLanguageTextAreaField('description', null); ?></div>
                </div>
                <div class="control-group" >
                    <div class="control-label"><label for="jform_-lbl" ><?php echo JText::_('COM_JEPROSHOP_FILE_LABEL'); ?></label></div>
