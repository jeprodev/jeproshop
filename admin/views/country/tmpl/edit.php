...
<form action="<?php echo JRoute::_('index.php?option=com_jeproshop&view=country'); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal" >
    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> >
        ...
        <div class="panel" >
            <div class="panel-title"><i class="icon-globe"></i> <?php echo JText::_('COM_JEPROSHOP_YOUR_ARE_ABOUT_TO_EDIT_LABEL') . ' ' . JText::_('COM_JEPROSHOP_COUNTRY_LABEL') . '  ' . strtoupper($this->country->name[$this->context->language->lang_id]); ?></div>
