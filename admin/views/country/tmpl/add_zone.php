...
<form action="<?php echo JRoute::_('index.php?option=com_jeproshop&view=country'); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal" >
    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> >
        ...
        <div class="panel" >
            <div class="panel-title" ><i class="icon-globe" ></i> <?php echo JText::_('COM_JEPROSHOP_YOU_ARE_ABOUT_TO_EDIT_LABEL') . ' ' . JText::_('COM_JEPROSHOP_ZONE_LABEL') . ' ' ;?></div>
            <div class="panel-content well" >
                <div class="control-group" >
                    ...
                    <div class="controls" ><input type="text" id="jform_name" name="jform[name]" required="required" /></div>
                </div>
                <div class="control-group" >
                    ...
                    <div class="controls" ><?php echo $this->helper->radioButton('allow_delivery', 'add', 1); ?></div>
                </div>
