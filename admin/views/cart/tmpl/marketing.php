    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> > 
        <div class="box_wrapper jeproshop_sub_menu_wrapper">
            <fieldset class="btn-group">
                ...
                <a href="<?php echo JRoute::_('index.php?option=com_jeproshop&view=cart&task=marketing'); ?>" class="btn jeproshop_sub_menu btn-success" ><i class="icon-marketing" ></i> <?php echo ucfirst(JText::_('COM_JEPROSHOP_MARKETING_LABEL')); ?></a>
            </fieldset>
        </div>
