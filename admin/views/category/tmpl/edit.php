...
<form action="<?php echo JRoute::_('index.php?option=com_jeproshop&view=category'); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="form-horizontal" >   
    ...
    <div id="j-main-container"  <?php if(!empty($this->sideBar)){ echo 'class="span10"'; }?> > 
        ...
        <div class="form_box_wrapper well" id="jform_edit_category">
        	<div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('name', 'jform', true, $this->context->controller->category->name); ?></div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageTextAreaField('description', 'jform', $this->context->controller->category->description); ?></div>
            </div>
            <div class="control-group">
             ...
             <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('meta_title', 'jform', true, $this->context->controller->category->meta_title); ?></div>
            </div>
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('meta_description', 'jform', true, $this->context->controller->category->meta_description); ?></div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls" ><?php echo $this->helper->multiLanguageInputField('link_rewrite', 'jform', true, $this->context->controller->category->link_rewrite); ?></div>
            </div>
                        ...
                        <tbody>
                            ...
                            <?php } else {     
                            	foreach($this->groups as $index => $group){ 
                                	$group_link = JRoute::_('index.php?option=com_jeproshop&view=group&task=edit&group_id=' . $group->group_id .'&' . JSession::getFormToken() .'=1');
                                ?>
